...
// const FarmingStatistics: React.FC = () => {
...
//         {/* fry-fee-collected and reward graphs */}
//         <div className="flex my-[15px] gap-[15px] md-m:flex-col">
//           <div className="flex flex-col gap-[18px] md-m:max-w-full  max-w-[50%] w-full px-[24px] py-[18px] bg-white rounded-[15px] shadow-[0px_4px_24.2px_0px_rgba(0,60,82,0.10)]">
//             <p className="font-bold text-black medium ">Reward rate information</p>

//             <AreaChart showYAxisTitle="Reward Rate ALGO per block" />
//           </div>
//           <div className="flex flex-col gap-[18px] md-m:max-w-full   max-w-[50%] w-full px-[24px] py-[18px] bg-white rounded-[15px] shadow-[0px_4px_24.2px_0px_rgba(0,60,82,0.10)]">
...
//               <div className="switcher flex justify-center items-center gap-[20px] sm-s:gap-[0px] w-fit p-[3px] bg-transparent rounded-[8px] border-solid border-2 border-[#FF8080]">
...
// export default FarmingStatistics

const FarmingStatistics = () => {
  return (
    <div className="flex flex-col items-center justify-center p-8">
      <h2 className="text-xl font-semibold text-gray-700 mb-2">Farming Statistics</h2>
