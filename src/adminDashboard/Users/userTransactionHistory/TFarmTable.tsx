...
const TFarmTable: React.FC = () => {
  const columns: TableColumnsType<DataType> = [
    ...
    },
    {
      ...
      key: 'type',
      render: (value) => (
        <p className="text-txtPending flex items-center justify-center small font-medium px-3 py-2 rounded-full bg-[#FDE9D1]">Farm</p>
      ),
    },
    {
